...
<head>
	...
	<script>
		var jsonStr = '{"notice.noticeId":"_noticeId","notice.name":"_name","notice.des":"_des","notice.typeId":"_typeId","notice.noticeType":"_noticeTypeName","notice.noticeDay":"_noticeDay","notice.empId":"_empId","notice.emps":"_empsName"}';
		...
		function showEditProductWin(){
			...
			if (rows.length > 1) {
                ...
                if (row) { // 有选中的行
            		...
            		replace("_noticeDay", row.noticeDay).replace("_empId", row.empId).replace("_empsName",row.emps.name);
	...
	<script>
		...
		function getNoticeType(){
			...
			$("#noticeTypes").textbox('setValue',rows[0].noticeTypeId);
...
<table id="list" class="easyui-datagrid"
	...
	<div id="tb" style="padding:5px;height:auto">
		<div style="margin-bottom:5px">
			...
			<a href="javascript:;" onclick="showAllProductWin();" class="easyui-linkbutton" plain="true" iconCls="icon-search">查询全部</a>
			...
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showNoticeTypeAll();">
						...
						<input type="hidden" id="noticeTypes" class="easyui-textbox" name="typeId"/>
					</a>
				</td>
			</tr>
			<tr>
