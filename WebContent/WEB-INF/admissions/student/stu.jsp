...
<table id="list" class="easyui-datagrid"
	...
	<tr>
		...
		<!-- <th data-options="field:'setIncome',width:33" formatter="showMoney">已缴费用</th> -->
		<th data-options="field:'address',width:90">住址</th>
		<th data-options="field:'grade',width:90" formatter="showName">班级</th>
		<th data-options="field:'room',width:90" formatter="showName">宿舍</th>
		...
		<th data-options="field:'role',width:90" formatter="formatterOptRole">班级角色</th>
	...
	<input type="hidden" name="stu.stuId"/>
		<table id="stuDetailsTable">
			...
			<td>&nbsp;&nbsp;入学时间</td>
				...
				<td>&nbsp;&nbsp;户口</td>
				<td><select style="width:100px;" class="easyui-combobox" name="stu.resIdence"><option value="countryside">农村</option><option value="city">城镇</option></select>
				</td>
				<!-- <td>&nbsp;&nbsp;班级</td>
			...
			<td>&nbsp;&nbsp;招生老师</td>
				...
				<td>&nbsp;&nbsp;班级角色</td>
				<td><select style="width:100px;" class="easyui-combobox" name="stu.role"><option value="monitor">班长</option><option value="studies">学习委员</option>
