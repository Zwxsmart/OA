...
<div id="addWin" class="easyui-window" title="添加工作日志" data-options="closed:true" style="width:500px;height:300px;">
	<form id="addForm">
		<table>
			...
			<tr>
				<td>日志时间</td>
				<td><input class="easyui-datetimebox" name="report.reportDay"/></td>
			</tr>
			<tr>
				<td>日志描述</td>
...
<div id="editWin" class="easyui-window" title="修改工作日志" data-options="closed:true" style="width:500px;height:300px;">
	<form id="editForm">
		...
		<table>
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showEmpAll1();">
						<input id="empNameInput1" class="easyui-textbox easyui-validatebox" name="report.empName" data-options="required:true"/>
			...
			<tr>
				<td>日志时间</td>
				<td><input class="easyui-datetimebox" name="report.reportDay" data-options="required:true,validType:'length[2,20]'"/></td>
			</tr>
			<tr>
				<td>日志描述</td>
				<td><input class="easyui-validatebox easyui-textbox" name="report.des" data-options="required:true,validType:'length[2,20]'"/></td>
