...
<table id="list" class="easyui-datagrid"
	...
	<tr>
		...
		<th data-options="field:'checkTime',width:125">巡查时间</th>
...
<div id="tb" style="padding:5px;height:auto">
	<div style="margin-bottom:5px">
		...
		<a href="javascript:;" onclick="removeProduct();" class="easyui-linkbutton" iconCls="icon-edit">删除</a>
			...
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showEmpWin1();">
						<input id="empInputName1" class="easyui-textbox easyui-validatebox" name="empName" data-options="required:true"/>
						<input id="empInputId1"  class="easyui-textbox" type="hidden" name="empId"/>
					</a>
				</td>
			</tr>
			<tr>
				<td>巡查时间</td>
				<td><input class="easyui-datetimebox" name="check.checkTime"/></td>
			</tr>
			<tr>
				<td>周几</td>
				<td>
					<select class="easyui-combobox" name="check.weekDay" style="width:150px;">
			...
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showGradeWin2();">
						<input id="gradeInputName2" class="easyui-textbox easyui-validatebox" name="gradeName" data-options="required:true"/>
						<input id="gradeInputId2" class="easyui-textbox" type="hidden" name="gradeId"/>
					</a>
				</td>
			</tr>
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showRoomWin3();">
						<input id="roomInputName3" class="easyui-textbox easyui-validatebox" name="roomName" data-options="required:true"/>
						<input id="roomInputId3" class="easyui-textbox" type="hidden" name="roomId"/>
					</a>
				</td>
			</tr>
			<tr>
				<td>巡查描述</td>
				<td><input class="easyui-validatebox easyui-textbox" name="check.des"/></td>
			</tr>
			<tr>
				<td>
	...
	<form id="editForm">
		...
		<table>
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showEmpEditWin1();">
						<input id="empEditInputName1" class="easyui-textbox easyui-validatebox" name="check.empName" data-options="required:true"/>
						<input id="empEditInputId1" class="easyui-textbox" type="hidden" name="empId" />
					</a>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>周几</td>
				<td>
					<select class="easyui-combobox" name="check.weekDay" style="width:200px;">
						<option value="星期一">星期一</option>
						<option value="星期二">星期二</option>
						<option value="星期三">星期三</option>
						<option value="星期四">星期四</option>
			...
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showGradeEditWin2();">
						<input id="gradeEditInputName2" class="easyui-textbox easyui-validatebox" name="check.gradeName" data-options="required:true"/>
						<input id="gradeEditInputId2" class="easyui-textbox" type="hidden" name="gradeId"/>
					</a>
				</td>
			</tr>
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showRoomEditWin3();">
						<input id="roomEditInputName3" class="easyui-textbox easyui-validatebox" name="check.roomName" data-options="required:true"/>
						<input id="roomEditInputId3" class="easyui-textbox" type="hidden" name="roomId"/>
					</a>
				</td>
			</tr>
			<tr>
				<td>巡查描述</td>
				<td><input class="easyui-validatebox easyui-textbox" name="check.des" data-options="required:true,validType:'length[2,20]'"/></td>
			</tr>
			<tr>
				<td>
