			...
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showEmpAll();">
						<input id="empNameInput" class="easyui-textbox" name="empName" data-options="required:true"/>
						<input type="hidden" id="emp" class="easyui-textbox" name="empId" data-options="required:true"/>
					</a>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showEmpAll1();">
						<input id="empNameInput1" class="easyui-textbox" name="empFeedBack.empName" data-options="required:true"/>
