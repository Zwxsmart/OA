...
<head>
	...
	<script>
        ...
        function formatterPwd(value, row, index){
        	if(value.pwd == "''") {
        		return "******"
        	}
        }
	...
	<input type="hidden" name="emp.empId"/>
		<table id="empDetailsTable">
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showRoomAll1();">
						<input id="roomInput1" class="easyui-textbox easyui-validatebox" name="emp.deptName" data-options="required:true"/>
						<input type="hidden" id="room1"  class="easyui-textbox" name="emp.depId"/>
					</a>
				</td>
				<td>&nbsp;&nbsp;职位</td>
				<td>
					<a href="javascript:;" onclick="showRoleAll1();">
						<input id="roleInput1" class="easyui-textbox easyui-validatebox" name="emp.roleName" data-options="required:true"/>
						<input type="hidden" id="role1"  class="easyui-textbox" name="emp.roleId"/>
					</a>
				</td>
				<td>&nbsp;&nbsp;密码</td>
				<td><input type="password" class="easyui-validatebox easyui-textbox " name="emp.pwd" data-options="required:true,validType:'length[4,32]'"/></td>
			</tr>
			<tr>
				<td>&nbsp;&nbsp;身份证号</td>
				<td><input class="easyui-validatebox easyui-textbox" name="emp.idCard" data-options="validType:'IDCard'"/></td>
				<td>&nbsp;&nbsp;籍贯</td>
			...
			<tr>
				...
				<td>&nbsp;&nbsp;手机号码</td>
				<td><input class="easyui-validatebox easyui-textbox" name="emp.phone" data-options="validType:'Mobile'"/></td>
				<td>&nbsp;&nbsp;QQ</td>
			...
			<tr>
				<td>联系人手机号码</td>
				<td><input class="easyui-validatebox easyui-textbox" name="emp.contactPhone" data-options="validType:'Mobile'"/></td>
				<td>&nbsp;&nbsp;毕业学校</td>
