...
<table id="list" class="easyui-datagrid"
	...
	<tr>
		...
		<th data-options="field:'endDay',width:125" formatter="formatTime">离职时间</th>
	...
	<form id="addForm">
		<table>
			<tr>
				...
				<td><input class="easyui-validatebox easyui-textbox" name="exp.company" data-options="required:true"/></td>
			</tr>
			<tr>
				<td>入职时间</td>
			...
			<tr>
				<td>工作职位</td>
				<td><input class="easyui-validatebox easyui-textbox" name="exp.jobTitle" data-options="required:true"/></td>
			</tr>
			<tr>
				<td>工作描述</td>
