...
<div id="addWin" class="easyui-window" title="添加反馈" data-options="closed:true" style="width:500px;height:300px;">
	<form id="addForm">
		<table>
			<tr>
				<td width="100px">反馈时间</td>
				<td><input class="easyui-datetimebox" name="empFeedBack.feedBackDay" data-options="editable:false"></td>
			</tr>
			<tr>
				<td>反馈详情</td>
				<td><input class="easyui-validatebox easyui-textbox" name="empFeedBack.des" data-options="required:true" style="width:100%;height:32px"/></td>
			</tr>
			<%-- <tr>
				<td>反馈状态</td>
				<td>
					<select style="width:172px;" class="easyui-combobox" name="empFeedBack.status"><option value="1">启用</option><option value="0">禁用</option></select>
				</td>
			</tr> --%>
			<tr>
				<td>
