...
<div id="addWin" class="easyui-window" title="添加巡查" data-options="closed:true" style="width:500px;height:300px;">
	<form id="addForm">
		<table>
			<tr>
				<td width="100px">巡查时间</td>
				<td><input class="easyui-datetimebox" name="check.checkTime" style="width:175px;" data-options="editable:false"/></td>
			</tr>
			<tr>
				<td>周几</td>
				<td>
					<select class="easyui-combobox" name="check.weekDay" style="width:175px;" data-options="editable:false">
			...
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showGradeWin2();">
						<input id="gradeInputName2" style="width:165px;" class="easyui-textbox easyui-validatebox" name="gradeName" data-options="required:true"/>
			...
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showRoomWin3();">
						<input id="roomInputName3" style="width:165px;" class="easyui-textbox easyui-validatebox" name="roomName" data-options="required:true"/>
			...
			<tr>
				<td>巡查描述</td>
				<td><input class="easyui-validatebox easyui-textbox" name="check.des" data-options="required:true" style="width:175px;height:32px"/></td>
			</tr>
			<tr>
				<td>
