...
<div id="addWin" class="easyui-window" title="添加谈心" data-options="closed:true" style="width:500px;height:300px;">
	<form id="addForm">
		<table>
			<tr>
...
<div id="editWin" class="easyui-window" title="修改谈心" data-options="closed:true" style="width:500px;height:300px;">
	<form id="editForm">
