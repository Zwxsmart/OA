            ...
            <div class="top-menu">
                <ul>
                    <nav class="cl-effect-5">
                        <li><a href="<%=path%>/stu/loginPage" class="active"><span data-hover="学生登陆">学生登陆</span></a></li>
    ...
    <div id="w" class="easyui-window" title="请先登录" style="width:400px;padding:20px 70px 20px 70px;">  
       <form action="<%=path %>/stu/login" method="post">
	        <div style="margin-bottom:10px"> 
	            <input class="easyui-textbox" name="stu.phone" id="logname" style="width:100%;height:30px;padding:12px" data-options="prompt:'电话号码',iconCls:'icon-man',iconWidth:38">  
	        </div>
