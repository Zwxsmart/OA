...
<script>
	...
	function showStuAllWin1(){
		  var row = $("#list").datagrid("getSelected");
		 $("#stuAllTable").datagrid({url:'<%=path %>/stu/queryAlls?str=1&termId='+row.gradeId + '&who='+'gradeId ='});
...
function showAllProductWin(){
  	$('#list').datagrid({ url: '<%=path %>/grade/queryAlls'}); 
  }
</script>
<script>
//模糊查询方法
