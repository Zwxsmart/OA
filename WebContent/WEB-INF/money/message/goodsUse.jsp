...
<table id="list" class="easyui-datagrid"
	...
	<tr>
		...
		<th data-options="field:'emp',width:80" formatter="formatterOpt3">员工名称</th>
		<th data-options="field:'quantity',width:70">领用数量</th>
		<th data-options="field:'useDay',width:125">领用时间</th>
		<th data-options="field:'des',width:80">申领原因</th>
		<th data-options="field:'ereturnDay',width:125">预还时间</th>
		<th data-options="field:'returnDay',width:125">归还时间</th>
...
<div id="addWin" class="easyui-window" title="添加物品领用" data-options="closed:true" style="width:500px;height:300px;">
	<form id="addForm">
		<table>
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showGoodsAll();">
						...
						<input type="hidden" id="goods" class="easyui-validatebox easyui-textbox" name="goodsId" data-options="required:true"/>
					</a>
				</td>
			</tr>
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showEmpAll();">
						...
						<input type="hidden" id="emp" class="easyui-validatebox easyui-textbox" name="empId" data-options="required:true"/>
					</a>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>领用时间</td>
				<td><input class="easyui-datetimebox" name="goodsUse.useDay"/></td>
			</tr>
			<tr>
				<td>预还时间</td>
				<td><input class="easyui-datetimebox" name="goodsUse.ereturnDay"/></td>
			</tr>
			<tr>
				<td>
...
<div id="editWin" class="easyui-window" title="修改物品领用" data-options="closed:true" style="width:500px;height:300px;">
	<form id="editForm">
		...
		<table>
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showGoodsAll1();">
						...
						<input type="hidden" id="goods1" class="easyui-validatebox easyui-textbox" name="goodsId" data-options="required:true"/>
					</a>
				</td>
			</tr>
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showEmpAll1();">
						...
						<input type="hidden" id="emp1" class="easyui-validatebox easyui-textbox" name="empId" data-options="required:true"/>
					</a>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>领用时间</td>
				<td><input class="easyui-datetimebox" name="goodsUse.useDay" data-options="required:true,validType:'length[2,20]'"/></td>
			</tr>
			<tr>
				<td>预还时间</td>
				<td><input class="easyui-datetimebox" name="goodsUse.ereturnDay" data-options="required:true,validType:'length[2,20]'"/></td>
			</tr>
			<tr>
				<td>
...
<div id="goodsDiv" class="easyui-window" title="所有员工" data-options="closed:true" style="width:500px;height:300px;">
	...
	<thead>
		<tr>
			...
			<th data-options="field:'quantity',width:60">物品总数</th>
			<th data-options="field:'des',width:80">物品描述</th>
			<th data-options="field:'unitPrice',width:60">物品单价</th>
			<th data-options="field:'buyDay',width:120">购买时间</th>
		</tr>
	</thead>
</table>
</div>
