...
<table id="list" class="easyui-datagrid"
	...
	<tr>
		...
		<th data-options="field:'buyDay',width:80">领用时间</th>
...
<div id="addWin" class="easyui-window" title="添加物品" data-options="closed:true" style="width:500px;height:300px;">
	<form id="addForm">
		<table>
			...
			<tr>
				<td>物品描述</td>
				<td><input class="easyui-validatebox easyui-textbox" name="goods.des" data-options="required:true,validType:'length[2,20]'"/></td>
			</tr>
			<tr>
				<td>物品单价</td>
			...
			<tr>
				<td>购买时间</td>
				<td><input class="easyui-datebox" name="goods.buyDay"/></td>
			</tr>
			<tr>
				<td>物品部门</td>
				<td>
...
<div id="editWin" class="easyui-window" title="修改物品" data-options="closed:true" style="width:500px;height:300px;">
	...
	<thead>
		<tr>
			...
			<th data-options="field:'des',width:100">物品描述</th>
		</tr>
	</thead>
</table>
</div>
...
<div id="purchaseWin" class="easyui-window" title="申购" data-options="closed:true" data-options="iconCls:'icon-save'" style="width:400px;height:300px;">
		<form id = "purchaseForm">
			...
			<tr>
				<td>领用原因</td>
				<td><input id="des" class="easyui-validatebox numberbox" style = "height:30px;" name="des" /></td>
				
			</tr>
			<tr>
				<td>预计归还时间</td>
				<td><input id="ereturnday" class="easyui-datebox" style = "height:30px;" name="des" /></td>
			</tr>
			<tr>
				<td>
