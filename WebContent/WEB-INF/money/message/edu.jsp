...
<div id="addWin" class="easyui-window" title="添加教育背景" data-options="closed:true" style="width:500px;height:300px;">
	<form id="addForm">
		<table>
			...
			<tr>
				<td>开始时间</td>
				<td><input class="easyui-datebox" name="edu.startDay"/></td>
			</tr>
			<tr>
				<td>结束时间</td>
				<td><input class="easyui-datebox" name="edu.endDay"/></td>
			</tr>
			<tr>
				<td>背景描述</td>
...
<div id="editWin" class="easyui-window" title="修改教育背景" data-options="closed:true" style="width:500px;height:300px;">
	<form id="editForm">
		...
		<table>
			...
			<tr>
				<td>开始时间</td>
				<td><input class="easyui-datebox" name="edu.startDay" data-options="required:true,validType:'length[2,20]'"/></td>
			</tr>
			<tr>
				<td>结束时间</td>
				<td><input class="easyui-datebox" name="edu.endDay" data-options="required:true,validType:'length[2,20]'"/></td>
			</tr>
			<tr>
				<td>背景描述</td>
				<td><input class="easyui-validatebox easyui-textbox" name="edu.des" data-options="required:true,validType:'length[2,20]'"/></td>
