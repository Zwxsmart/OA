...
<table id="list" class="easyui-datagrid"
	...
	<tr>
		...
		<th data-options="field:'appDay',width:125">申购时间</th>
...
<div id="addWin" class="easyui-window" title="添加物品申购" data-options="closed:true" style="width:500px;height:300px;">
	<form id="addForm">
		<table>
			<tr>
				<td>物品名称</td>
				<td><input class="easyui-validatebox easyui-textbox" name="goodsApp.goodsName" data-options="required:true,validType:'length[2,20]'"/></td>
			</tr>
			<tr>
				<td>物品数量</td>
			...
			<tr>
				<td>申购原因</td>
				<td><input class="easyui-validatebox easyui-textbox" name="goodsApp.des" data-options="required:true,validType:'length[2,20]'"/></td>
			</tr>
			<tr>
				<td>状态</td>
				<td>
