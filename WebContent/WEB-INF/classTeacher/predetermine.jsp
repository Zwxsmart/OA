...
<div id="tb" style="padding:5px;height:auto">
	<div style="margin-bottom:5px">
		...
		<a href="javascript:;" onclick="showDisabledProductWin();" class="easyui-linkbutton" iconCls="icon-search">查看全部预定学生</a>
		<a href="javascript:;" onclick="showEnabledProductWin();" class="easyui-linkbutton" iconCls="icon-search">查看冻结预定学生</a>
