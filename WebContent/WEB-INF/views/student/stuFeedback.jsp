...
<head>
	...
	<script>
        ...
        function showAddProductWin() {
            ...
            authority('com.cs.action.StuFeedbackAction.save', "", "save");
        }
        ...
        function showEditProductWin() {
            ...
            if (rows.length > 1) {
                ...
                if (row) { // 有选中的行
                	...
                	authority('com.cs.action.StuFeedbackAction.update', jsonStr1, "update");
                }
...
<table id="list" class="easyui-datagrid"
	...
	<tr>
		...
		<th data-options="field:'feedbackDay',width:100"  formatter="formatTime">反馈时间</th>
