...
<head>
	...
	<script>
        ...
        function showAddProductWin() {
            ...
            authority('com.cs.action.JobAction.save', "", "save");
        }
        ...
        function showEditProductWin() {
            ...
            if (rows.length > 1) {
                ...
                if (row) { // 有选中的行
                    ...
                    authority('com.cs.action.JobAction.update', jsonStr1, "update");
...
<table id="list" class="easyui-datagrid"
	...
	<tr>
		...
		<th data-options="field:'hireDay',width:100" formatter="formatTime">入职时间</th>
...
<div id="addWin" class="easyui-window" title="添加就业信息" data-options="closed:true" style="width:500px;height:300px;">
	<form id="addForm">
		<table>
			<tr>
...
<div id="editWin" class="easyui-window" title="修改就业信息" data-options="closed:true" style="width:500px;height:300px;">
	<form id="editForm">
