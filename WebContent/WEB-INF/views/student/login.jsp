...
<div class="header" id="home">
            ...
            <div class="top-menu">
                <ul>
                    <nav class="cl-effect-5">
                        <li><a href="<%=path%>/student/loginPage" class="active"><span data-hover="学生登陆">学生登陆</span></a></li>
    ...
    <div id="w" class="easyui-window" title="请先登录" style="width:400px;padding:20px 70px 20px 70px;">  
       <form action="<%=path %>/stu/login" method="post">
        <div style="margin-bottom:10px">  
            <input class="easyui-textbox" name="stu.phone" id="logname" style="width:100%;height:30px;padding:12px" data-options="prompt:'登录邮箱',iconCls:'icon-man',iconWidth:38">  
        </div>  
        <div style="margin-bottom:20px">  
            <input class="easyui-textbox" name="stu.pwd" id="logpass" type="password" style="width:100%;height:30px;padding:12px" data-options="prompt:'登录密码',iconCls:'icon-lock',iconWidth:38">  
        </div>  
        <div style="margin-bottom:20px">  
            <input class="easyui-textbox" type="text" id="logyzm" style="width:50%;height:30px;padding:12px" data-options="prompt:'验证码'"> 
            <img id="verImg" src="/kaptch?time=Math.random();" onclick="this.src='/kaptch?time=Math.random();'">
        </div>  
        <div style="margin-bottom:20px">  
