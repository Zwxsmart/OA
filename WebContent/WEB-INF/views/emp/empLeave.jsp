...
<head>
	...
	<script>
        ...
        function showEditProductWin() {
            ...
            if (rows.length > 1) {
                $.messager.alert("提示", "请先选择一个需要修改的员工请假", "info");
        ...
        function removeProduct() {
            ...
            if (row) {
                ...
                $.messager.alert("提示", "请先选择需要删除的请假", "info");
            }
        }
        ...
        function formatterOptt1(value, row, index) {
        	if (row.firstLevel == 2 && row.pass == 2){
        		return "<b>已审核</b>"
        	} else if (row.leaveCount > 3 || row.firstLevel == 2) {
...
<!-- 组合搜索框div -->
	<div id="mm" style="width:120px">
	    <div data-options="name:'e.name'">员工姓名</div>
	</div>
...
<div id="addWin" class="easyui-window" title="添加员工请假信息" data-options="closed:true" style="width:500px;height:300px;">
	<form id="addForm">
		<table>
			...
			<tr>
				<td>提交时间</td>
				<td><input class="easyui-datetimebox" name="empLeave.leaveDay" data-options="editable:false"></td>
			</tr>
			<tr>
				<td>请假描述</td>
