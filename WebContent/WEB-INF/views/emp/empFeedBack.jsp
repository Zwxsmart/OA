...
<head>
	...
	<script>
        ...
        function showAddProductWin() {
            ...
            authority("com.cs.action.EmpFeedBackAction.save","","save");
        }

        function addProduct() {
            if ($("#addForm").form("validate")) {
                $.post("<%=path %>/empFeedBack/save",
                    $("#addForm").serialize(),
                    function (data) {
                        if (data.result.result == "success") {
        ...
        function showEditProductWin() {
            ...
            if (rows.length > 1) {
                ...
                if (row) { // 有选中的行
                    ...
                    authority("com.cs.action.EmpFeedBackAction.update",jsonStr1,"update");
                }
...
<table id="list" class="easyui-datagrid"
	...
	<tr>
		...
		<th data-options="field:'feedBackDay',width:125"  formatter="formatTime">反馈时间</th>
			...
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showEmpAll();">
						<input id="empNameInput" class="easyui-textbox" style="width:165px;" name="empName" data-options="required:true"/>
						<input type="hidden" id="emp" name="empId" class="easyui-textbox"/>
					</a>
				</td>
			</tr>
			<tr>
				<td>反馈时间</td>
				<td><input class="easyui-datetimebox" name="empFeedBack.feedBackDay" style="width:175px;" data-options="editable:false"></td>
			</tr>
			<tr>
				<td>反馈详情</td>
				<td><input class="easyui-validatebox easyui-textbox" name="empFeedBack.des" data-options="required:true" style="width:175px;height:32px"/></td>
			</tr>
			<%-- <tr>
				<td>反馈状态</td>
				<td>
	...
	<form id="editForm">
		...
		<table>
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showEmpAll1();">
						<input id="empNameInput1" class="easyui-textbox" style="width:165px;" name="empFeedBack.empName" data-options="required:true"/>
						<input type="hidden" id="emp1" name="empId" class="easyui-textbox"/>
					</a>
				</td>
			<tr>
				<td>反馈时间</td>
			...
			<tr>
				<td>反馈状态</td>
				<td>
					<select style="width:175px;" class="easyui-combobox" name="empFeedBack.status"><option value="1">启用</option><option value="0">禁用</option></select>
				</td>
			</tr>
			<tr>
				<td>
