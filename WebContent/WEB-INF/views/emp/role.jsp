...
<head>
	...
	<script>
        ...
        function showAddProductWin() {
            ...
            authority("com.cs.action.RoleAction.add","","save");
        }
        ...
        function showEditProductWin() {
            ...
            if (rows.length > 1) {
                ...
                if (row) { // 有选中的行
                    ...
                    authority("com.cs.action.RoleAction.update",jsonStr1,"update");
                }
	...
	<form id="addForm">
		<table>
			<tr>
				...
				<td>
					<select class="easyui-combobox" name="role.name" style="width:175px;" data-options="editable:false">
						<option value="学生">学生</option>
						<option value="辅导老师">老板</option>
			...
			<tr>
				<td>介绍</td>
				<td><input class="easyui-validatebox easyui-textbox" name="role.des" data-options="required:true" style="width:175px;height:32px"/></td>
			</tr>
			<%-- <tr>
				<td>状态</td>
				<td>
	...
	<form id="editForm">
		...
		<table>
			...
			<tr>
				<td>状态</td>
				<td>
					<select style="width:175px;" class="easyui-combobox" name="role.status"><option value="1">启用</option><option value="0">禁用</option></select>
				</td>
			</tr>
			<tr>
				<td>
