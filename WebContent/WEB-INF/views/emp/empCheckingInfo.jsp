...
<head>
	...
	<script>
        ...
        function showAddProductWin() {
            ...
            authority("com.cs.action.EmpCheckingInfoAction.save","","save");
        }
        ...
        function showEditProductWin() {
            ...
            if (rows.length > 1) {
                ...
                if (row) { // 有选中的行
                    ...
                    authority("com.cs.action.EmpCheckingInfoAction.update",jsonStr1,"update");
                }
...
<table id="list" class="easyui-datagrid"
	...
	<tr>
		...
		<th data-options="field:'checkingTime',width:100"  formatter="formatTime">考勤时间</th>
	</tr>
	</thead>
</table>
