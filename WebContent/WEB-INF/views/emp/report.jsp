...
<head>
	...
	<script>
        ...
        function showAddProductWin() {
            ...
            authority("com.cs.action.ReportAction.save","","save");
        }

        function addProduct() {
            if ($("#addForm").form("validate")) {
                $.post("<%=path %>/report/save",
                    $("#addForm").serialize(),
                    function (data) {
                        if (data.result.result == "success") {
        ...
        function showEditProductWin() {
            ...
            if (rows.length > 1) {
                ...
                if (row) { // 有选中的行
                    ...
                    authority("com.cs.action.ReportAction.update",jsonStr1,"update");
                }
...
<table id="list" class="easyui-datagrid"
	...
	<tr>
		...
		<th data-options="field:'reportDay',width:125" formatter="formatTime">日志时间</th>
...
<div id="addWin" class="easyui-window" title="添加工作日志" data-options="closed:true" style="width:500px;height:300px;">
	<form id="addForm">
		<table>
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showEmpAll();">
						<input id="empNameInput" class="easyui-textbox easyui-validatebox" style="width:165px;" name="empName" data-options="required:true"/>
			...
			<tr>
				<td>日志时间</td>
				<td><input class="easyui-datetimebox" name="report.reportDay"  style="width:175px;" data-options="editable:false"/></td>
			</tr>
			<tr>
				<td>日志描述</td>
				<td><input class="easyui-validatebox easyui-textbox" name="report.des" data-options="required:true" style="width:175px;height:32px"/></td>
			</tr>
			<%-- <tr>
				<td>状态</td>
...
<div id="editWin" class="easyui-window" title="修改工作日志" data-options="closed:true" style="width:500px;height:300px;">
	<form id="editForm">
		...
		<table>
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="showEmpAll1();">
						<input id="empNameInput1" class="easyui-textbox easyui-validatebox" style="width:165px;" name="report.empName" data-options="required:true"/>
			...
			<tr>
				<td>状态</td>
				<td><select style="width:175px;" class="easyui-combobox" name="report.status"><option value="1">启用</option><option value="0">禁用</option></select></td>
			</tr>
			<tr>
				<td>
