	...
	<script>
	   ...
	   var jsonStr = '{"stu.stuId":"_stuId","stu.stuNo":"_stuNo",' +
        ...
        function showAddProductWin() {
            ...
            authority('com.cs.action.StuPredetermineAction.save', "", "save");
        }
        ...
        function showEditProductWin() {
            ...
            if (rows.length > 1) {
                ...
                if (row) { // 有选中的行
                   ...
                   authority('com.cs.action.StuPredetermineAction.update', jsonStr1, "update");
                }
        ...
        function editProduct() {
            if ($("#editForm").form("validate")) {
          		var rows = $("#list").datagrid("getSelections");
                $.post("<%=path %>/predetermine/update?id="+rows[0].stuId,
                    $("#editForm").serialize(),
                    function (data) {
                        if (data.result.result == "success") {
...
<table id="list" class="easyui-datagrid"
	...
	<tr>
		...
		<th data-options="field:'incomes',width:60" formatter="stuMoney">金额</th>
...
<div id="tb" style="padding:5px;height:auto">
	<div style="margin-bottom:5px">
		...
		<a href="javascript:;" onclick="showAllProductWin();" class="easyui-linkbutton" iconCls="icon-search">查看全部预定学生</a>
...
<div id="predetermineWin" class="easyui-window" title="转为预定学生" data-options="closed:true" data-options="iconCls:'icon-save'" style="width:400px;height:300px;">
		<form id = "predetermineForm">
			...
			<tr>
				<td>请交转为正式学生的费用</td>
				<td><input id="predetermineMoney" class="easyui-validatebox numberbox" style = "height:30px;" name="money"  data-options="required:true"/></td>
